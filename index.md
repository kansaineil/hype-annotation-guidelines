...
| **2** | [Hyperbolic](#step2) | Is the evaluation exaggerated or extreme? |
| **3a** | [Gratuitous](#step3a) | If removed, does the sentence meaning remain essentially unchanged? |
| **3b** | [Amplified](#step3b) | Is the force increased by modifiers (highly, extremely, completely…)? |
| **3c** | [Grounds](#step3c) | Are justifications or evidence provided to support the evaluation? |
...
**YES → HYPE**  
- Removing the adjective does not change propositional content

**NO → NOT HYPE**  
- Removing it would substantially alter propositional content
...
- Strength increased by  
  - modifiers (highly, very, completely), and/or  
  - stance verbs with stronger assertiveness (demonstrate vs. show vs. suggest)
...
**YES → HYPE**  
- Stacking with other hype candidates  
- Other promotional signals present
...
- Comparative or cautious use (e.g., more, less, lack of, may, can)
...
**NO →**  
- Adjective presented absolutely  
