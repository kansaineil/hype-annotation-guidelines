...
### **1. Value-judgement**  
- Usually **value-judgement**. Expresses **highest importance, aspiration, or priority**.  Typical examples: *goal, objective, aim, outcome, purpose, success, development, impact, understanding, hope, benefit, strength, cure, intent, utility, vision, intention, potential, beneficiaries, elimination, decision, responsibility, role, function, translation, application, treatment, use*. 
